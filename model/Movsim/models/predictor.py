...
class Predictor(nn.Module):
    ...
    def __init__(self, total_locations=2499, embedding_dim=32, hidden_dim=64, cuda=None):
    ...
    def forward(self, loc_seq):
        """
        try to predict a sequence of [0: seq_len - 1] => [1: seq_len]
        :param loc_seq: (batch_size * 47)
        :return:
        """
